...
bool ShadowMapTechnique::Init()
{
    ...
    if (!AddShader(GL_VERTEX_SHADER, "D:/VS_programs/shaders/shaders6_4/shadow_map.vs")) {
        return false;
    }

    if (!AddShader(GL_FRAGMENT_SHADER, "D:/VS_programs/shaders/shaders6_4/shadow_map.fs")) {
        return false;
    }
