...
public:
    ...
    bool Init()
    {
		...
		if (!m_quad.LoadMesh("D:/VS_programs/Content/quad.obj")) {
            return false;
        }

		m_pGroundTex = new Texture(GL_TEXTURE_2D, "D:/VS_programs/Content/test.png");

        if (!m_pGroundTex->Load()) {
            return false;
        }

		if (!m_mesh.LoadMesh("D:/VS_programs/Content/phoenix_ugv.md2")) {
			return false;
		}
